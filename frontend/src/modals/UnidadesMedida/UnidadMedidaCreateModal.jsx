...
const UnidadMedidaCreateModal = ({ show, onClose, token, onSuccess }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showSuccessAlert('Unidad de medida creada');
      onSuccess && onSuccess();
      onClose();
    } catch (err) {
  ...
  return (
    <ModalBase show={show} onClose={onClose} header={<>
      <h5 className="modal-title">Agregar Unidad de Medida</h5>
...
UnidadMedidaCreateModal.propTypes = {
...
export default UnidadMedidaCreateModal;
