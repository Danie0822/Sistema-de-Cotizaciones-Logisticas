...
const ImpuestoCreateModal = ({ show, onClose, onSuccess, tipoCargaOptions }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showSuccessAlert('Impuesto creado exitosamente');
      onSuccess && onSuccess();
      onClose();
    } catch (err) {
  ...
  return (
    <ModalBase show={show} onClose={onClose} header={
      <>
        <h5 className="modal-title">Agregar Impuesto</h5>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-check mb-3">
          <input
            ...
            id="esAcumulativo"
          />
          <label className="form-check-label" htmlFor="esAcumulativo">
...
export default ImpuestoCreateModal;
